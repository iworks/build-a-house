...
class iworks_build_a_house_posttypes {
	...
	public function register_taxonomy_location() {
		 ...
		 */
		$labels = array(
			'name'                       => _x( 'Locations', 'Taxonomy General Name', 'build_a_house' ),
			'singular_name'              => _x( 'Locations', 'Taxonomy Singular Name', 'build_a_house' ),
			'menu_name'                  => __( 'Locations', 'build_a_house' ),
			'all_items'                  => __( 'All Locations', 'build_a_house' ),
			'new_item_name'              => __( 'New Locations Name', 'build_a_house' ),
			'add_new_item'               => __( 'Add New Locations', 'build_a_house' ),
			'edit_item'                  => __( 'Edit Locations', 'build_a_house' ),
			'update_item'                => __( 'Update Locations', 'build_a_house' ),
			'view_item'                  => __( 'View Locations', 'build_a_house' ),
			'separate_items_with_commas' => __( 'Separate Locations with commas', 'build_a_house' ),
			'add_or_remove_items'        => __( 'Add or remove Locations', 'build_a_house' ),
			'choose_from_most_used'      => __( 'Choose from the most used', 'build_a_house' ),
			'popular_items'              => __( 'Popular Locations', 'build_a_house' ),
			'search_items'               => __( 'Search Locations', 'build_a_house' ),
			'not_found'                  => __( 'Not Found', 'build_a_house' ),
			'no_terms'                   => __( 'No items', 'build_a_house' ),
			'items_list'                 => __( 'Locations list', 'build_a_house' ),
			'items_list_navigation'      => __( 'Locations list navigation', 'build_a_house' ),
		);
		$args   = array(
			'labels'             => $labels,
			'hierarchical'       => true,
